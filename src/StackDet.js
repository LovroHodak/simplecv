...
export default function StackDet() {
  return (
    <div style={{ backgroundColor: "#43262D" }}>
      ...
      <div className="aboutDetDiv">
        ...
        >
          ...
          <Card.Img src="https://www.tremplin-numerique.org/wp-content/uploads/2021/06/Quoi-de-neuf-dans-la-norme-ES2021-pour-JavaScript-%E2%80%93.jpg" />
        </Card>
      ...
      <div className="aboutDetDiv">
        ...
        >
          <Card.Img src="https://res.cloudinary.com/practicaldev/image/fetch/s--ljmYNm3i--/c_imagga_scale,f_auto,fl_progressive,h_900,q_auto,w_1600/https://www.freecodecamp.org/news/content/images/size/w2000/2020/02/Ekran-Resmi-2019-11-18-18.08.13.png" />
        </Card>
      ...
      <div className="aboutDetDiv">
        ...
        >
          <Card.Img src="https://fungsitama.web.id/wp-content/uploads/2020/08/0_cQTv5n6xV7opBBIB.png" />
        </Card>
      ...
      <div className="aboutDetDiv">
        ...
        >
          <Card.Img src="https://www.etf.europa.eu/sites/default/files/styles/xx_large/public/2021-05/writing-hand-number-finger-training-education_49805454192_o.jpg?h=7fe0a142&itok=wxdgnLyp" />
        </Card>
